...
#the data is now ready in a combined and filtered format. Some data linkage could be done in R but has been done in excel instead (identifying inhaler categories, carbon contents, dry powder caps etc.)
```
